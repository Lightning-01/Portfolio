  ...
  return (
    <div className="home__data">
        ...
        <h3 className="home__subtitle">
            Software Developer | Machine Learning & DevOps Enthusiast
        </h3>
        <p className="home__description">
        Passionate about building efficient and scalable software solutions. Interested in leveraging AI, ML, and DevOps to enhance system performance and automation.
        </p>
